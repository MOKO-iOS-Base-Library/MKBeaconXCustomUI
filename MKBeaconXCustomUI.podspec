...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of MKBeaconXCustomUI.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/aadyx2007@163.com/MKBeaconXCustomUI'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'aadyx2007@163.com' => 'aadyx2007@163.com' }
  s.source           = { :git => 'https://github.com/aadyx2007@163.com/MKBeaconXCustomUI.git', :tag => s.version.to_s }
